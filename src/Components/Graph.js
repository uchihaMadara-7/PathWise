...
/* Since the size of each grid box is 44px = 4px of border and 40px of box */
export const graph_row = parseInt(window.innerHeight / 44) - 1;
export const graph_col = parseInt(window.innerWidth / 44);
